...
import { deteleBook, getAllData } from "./store/slices/bookSlice";
...
const App: React.FC = () => {
  ...
  const books = useSelector((data: any) => {
    console.log("1", data.book.books);
    return data.book.books;
  });
  ...
  const handleDelete = (id: number | string) => {
    let choice = confirm("ban co xac nhan xoa :");
    if (choice) {
      dispatch(deteleBook(id));
    }
  };
